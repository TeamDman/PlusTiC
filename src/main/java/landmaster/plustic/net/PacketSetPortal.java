...
public class PacketSetPortal implements IMessage {
    ...
    public static IMessage onMessage(PacketSetPortal message, MessageContext ctx) {
        ...
        mainThread.addScheduledTask(() -> {
            ...
            Vec3d eye = ep.getPositionVector().add(new Vec3d(0, ep.getEyeHeight(), 0));
            ...
            if (!ep.isSneaking()) {
                ...
                if (Portal.canUse(nbt)) {
                    ...
                    ep.sendMessage(new TextComponentTranslation("msg.plustic.portal.set", nick.getInteger("x"), nick.getInteger("y"), nick.getInteger("z"), nick.getInteger("dim")));
                }
                ...
                ep.sendMessage(new TextComponentTranslation("msg.plustic.portal.armor.set", newCoord.xCoord, newCoord.yCoord, newCoord.zCoord, newCoord.dimensionId));
            }
        });
        return null;
    }
