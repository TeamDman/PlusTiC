...
public class Invariant extends AbstractArmorTrait {
    ...
    public void onExplosion(ExplosionEvent.Detonate event) {
        ...
        List<EntityPlayer> list = event.getWorld().getEntitiesWithinAABB(EntityPlayer.class, Utils.AABBfromVecs(
                ...
                event.getExplosion().getPosition().add(new Vec3d(10, 10, 10))),
                player -> Optional.ofNullable(ArmorAbilityHandler.getArmorAbilitiesData(player))
                        ...
                        .map(Toggle.IToggleArmor::getDisabled)
