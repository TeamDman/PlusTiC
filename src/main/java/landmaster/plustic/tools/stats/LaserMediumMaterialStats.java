...
public class LaserMediumMaterialStats extends AbstractMaterialStats {
    ...
    public List<String> getLocalizedInfo() {
        return ImmutableList.of(I18n.format("stat.laser_medium.power.name", power), I18n.format("stat.laser_medium.range.name", range));
    }

    @Override
    public List<String> getLocalizedDesc() {
        return ImmutableList.of(I18n.format("stat.laser_medium.power.desc"), I18n.format("stat.laser_medium.range.desc"));
    }
}
