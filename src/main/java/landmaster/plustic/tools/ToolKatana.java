...
public class ToolKatana extends SwordCore {
    ...
    public static void render(RenderGameOverlayEvent event) {
        ...
        if (event.getType() == RenderGameOverlayEvent.ElementType.TEXT
            ...
            if (counter > 0) { mc.fontRenderer.drawString(I18n.format("meter.plustic.katana",
                    String.format("%.1f", counter)), 5, 5, Color.HSBtoRGB(Math.min(counter / (counter_cap(is) * 3), 1.0f / 3), 1, 1) & 0xFFFFFF, true);
            }
        }
    }
