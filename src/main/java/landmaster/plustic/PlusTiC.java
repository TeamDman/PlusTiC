...
public class PlusTiC {
    ...
    public static final Logger log = LogManager.getLogger(ModInfo.MODID.toUpperCase(Locale.US)); // to avoid problems with Turkish
    ...
    private static final String[] renamesToHandle = new String[] { "osmium", "titanium", "iridium", "enderium", "lumium", "platinum", "signalum", "invar" };
