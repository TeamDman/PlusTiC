...
public class Utils {
    ...
    public static RayTraceResult raytraceEntityWithPred(Entity entity, Vec3d start, Vec3d look, double range, boolean ignoreCanBeCollidedWith, Predicate<? super Entity> pred) {
        ...
        Vec3d direction = start.add(new Vec3d(look.x * range, look.y * range, look.z * range));
        ...
        List<Entity> entitiesInArea = entity.getEntityWorld().getEntitiesInAABBexcluding(entity, bb, EntitySelectors.NOT_SPECTATING.and(pred)::test);
