...
public class ModuleTools implements IModule {
    ...
    public static void initItems(RegistryEvent.Register<Item> event) {
        ...
        if (Config.laserGun) {
            ...
            TinkerRegistry.addMaterialStats(TinkerMaterials.blaze, new BatteryCellMaterialStats(85000), new LaserMediumMaterialStats(3.2f, 17));
            TinkerRegistry.addMaterialStats(TinkerMaterials.endrod, new BatteryCellMaterialStats(260000), new LaserMediumMaterialStats(8.6f, 38));
        ...
        for (IModifier modifier : new IModifier[]{
            ...
            PlusTiC.proxy.registerModifierModel(modifier, new ResourceLocation(ModInfo.MODID, "models/item/modifiers/" + modifier.getIdentifier()));
        }
    }
